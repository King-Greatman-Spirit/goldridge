...
def admin_register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # messages.success(request, 'Thanks for registering with us as an admin. You have been sent a verification email, please verify it.')
            return redirect('/accounts/admin_login/?command=verification&email='+email)
